...
import { AddressZero } from "../../scripts/common";

task("fil-addr", "Convert FIL address format")
  .addVariadicPositionalParam("addrs", "Fil addresses in fil/eth format", [AddressZero, "t410faaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaonc6iji", "t010"])
